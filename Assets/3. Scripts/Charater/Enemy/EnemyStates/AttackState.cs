...
public class AttackState : IState
{
    ...
    IEnumerator meleeAttack()
    {
        ...
        parent.CreateResource(Resources.Load("EnemyAttack/BaseMelee_Attack") as GameObject, parent.ExitPoint);
    ...
    IEnumerator rangedAttack()
    {
        ...
        parent.CreateResource(Resources.Load("EnemyAttack/BaseRanged_Attack") as GameObject, parent.ExitPoint);
    ...
    IEnumerator RushAttack()
    {
        ...
        parent.RushSpeed = 7f;
        parent.CreateResource(Resources.Load("EnemyAttack/BaseRush_Attack") as GameObject, parent.ExitPoint);
    ...
    IEnumerator AOEAttack()
    {
        ...
        parent.CreateResource(Resources.Load("EnemyAttack/BaseAOE_Attack") as GameObject, parent.MyTarget);
        parent.IsAttacking = false;
    }
}
