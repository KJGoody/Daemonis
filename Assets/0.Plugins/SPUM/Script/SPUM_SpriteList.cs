...
public class SPUM_SpriteList : MonoBehaviour
{
    ...
    public void ChangeItem(int partNum)
    {
        if (Player.MyInstance.usingEquipment[partNum] != null) // 착용한 장비가 있음
        {
            ...
            {
                case 0:  // 모자
                    _hairList[1].sprite = Player.MyInstance.usingEquipment[partNum].GetItemSprite(1);
                    break;
                ...
                case 1:  // 옷
                    for (var i = 1; i < 4; i++)
                    {
                        switch (Player.MyInstance.usingEquipment[partNum].GetItemSpriteName(i))
                        {
                            ...
                            case "Left":
                                _clothList[1].sprite = Player.MyInstance.usingEquipment[partNum].GetItemSprite(i);
                                break;

                            case "Right":
                                _clothList[2].sprite = Player.MyInstance.usingEquipment[partNum].GetItemSprite(i);
                                break;
                ...
                case 2: // 신발
                    for (var i = 1; i < 3; i++)
                    {
                        switch (Player.MyInstance.usingEquipment[partNum].GetItemSpriteName(i))
                        {
                            ...
                            case "Right":
                                _pantList[1].sprite = Player.MyInstance.usingEquipment[partNum].GetItemSprite(i);
                                break;
                        }
                    }
                    break;
                ...
                case 3:  // 무기
                    _weaponList[0].sprite = Player.MyInstance.usingEquipment[partNum].GetItemSprite(1);
                    break;
                ...
                case 4:  // 어깨
                    for (var i = 1; i < 3; i++)
                    {
                        switch (Player.MyInstance.usingEquipment[partNum].GetItemSpriteName(i))
                        {
                            ...
                            case "Right":
                                _armorList[2].sprite = Player.MyInstance.usingEquipment[partNum].GetItemSprite(i);
                                break;
                        }
                    }
                    break;
                ...
                case 5:  // 망토
                    _backList[0].sprite = Player.MyInstance.usingEquipment[partNum].GetItemSprite(1);
                    break;
